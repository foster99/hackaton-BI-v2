...
class VaccinesPetWidget extends StatefulWidget {
  VaccinesPetWidget({
    Key key,
    this.userProfile,
  }) : super(key: key);
  ...
  @override
  _VaccinesPetWidgetState createState() => _VaccinesPetWidgetState();
}

class _VaccinesPetWidgetState extends State<VaccinesPetWidget> {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<UsersRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final vaccinesPetUsersRecord = snapshot.data;
        return Scaffold(
          key: scaffoldKey,
          appBar: AppBar(
