...
import 'package:pet_heath/login_page/login_page_widget.dart';
import 'flutter_flow/flutter_flow_theme.dart';
...
class _MyAppState extends State<MyApp> {
  Stream<PetHeathFirebaseUser> userStream;
  PetHeathFirebaseUser initialUser;
  final authUserSub = authenticatedUserStream.listen((_) {});

  @override
  void initState() {
    super.initState();
    userStream = petHeathFirebaseUserStream()
