...
abstract class AppointmentsRecord
  ...
  @nullable
  DocumentReference get appointmentPet;

  @nullable
  String get appointmentPetName;
...
Map<String, dynamic> createAppointmentsRecordData({
  ...
  DocumentReference appointmentPet,
  String appointmentPetName,
}) =>
    serializers.toFirestore(
        ...
        AppointmentsRecord((a) => a
          ...
          ..appointmentPetName = appointmentPetName));
