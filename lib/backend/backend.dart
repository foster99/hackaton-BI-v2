...
import 'schema/vets_record.dart';
...
export 'schema/vets_record.dart';
...
Stream<List<VetsRecord>> queryVetsRecord(
        {Query Function(Query) queryBuilder,
        int limit = -1,
        bool singleRecord = false}) =>
    queryCollection(VetsRecord.collection, VetsRecord.serializer,
        queryBuilder: queryBuilder, limit: limit, singleRecord: singleRecord);
