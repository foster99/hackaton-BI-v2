...
class TreatmentsPetWidget extends StatefulWidget {
  TreatmentsPetWidget({
    Key key,
    this.userProfile,
  }) : super(key: key);
  ...
  @override
  _TreatmentsPetWidgetState createState() => _TreatmentsPetWidgetState();
}

class _TreatmentsPetWidgetState extends State<TreatmentsPetWidget> {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<UsersRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final treatmentsPetUsersRecord = snapshot.data;
        return Scaffold(
          key: scaffoldKey,
          appBar: AppBar(
